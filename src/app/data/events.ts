...
export function eventsDummyData(): Event[]{
    ...
    const members:Member[] = [
        {id:'1', email:'taiwoteninlanimi@gmail.com', color:'red', firstName:'Teninlanimi', lastName:'Taiwo', phoneNumber:'+2349068345482', role:'admin', profile:'https://res.cloudinary.com/dq18zmq0f/image/upload/v1732807848/file.jpg'},
        {id:'2', email:'teninlanimitaiwo@gmail.com', color:'green', firstName:'Fola', lastName:'Taiwo', phoneNumber:'+2349068345482', role:'student', profile:'https://imgcdn.stablediffusionweb.com/2024/5/8/579453e2-3fa3-4d2c-a059-ccc3096780f3.jpg'},
        ...
        {id:'4', email:'teni@gmail.com', color:'purple', firstName:'Bamidele', lastName:'Taiwo', phoneNumber:'+2349068345482', role:'student', profile:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOeZjZWEr4oFmJhILQQgTy7-WUX9BmRrAAFw&s'},
        {id:'5', email:'tai@gmail.com', color:'teal', firstName:'Teni', lastName:'Taiwo', phoneNumber:'+2349068345482', role:'student', profile:'https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fmen%2F&psig=AOvVaw3tt5LhAhA799g-pEhib0Bj&ust=1732916963361000&source=images&cd=vfe&opi=89978449&ved=0CBQQjRxqFwoTCPiL0fmAgIoDFQAAAAAdAAAAABAJ'},
        {id:'6', email:'avffg@gmail.com', color:'red', firstName:'David', lastName:'Taiwo', phoneNumber:'+2349068345482', role:'student', profile:'https://res.cloudinary.com/dq18zmq0f/image/upload/v1732807848/file.jpg'},
    ]
